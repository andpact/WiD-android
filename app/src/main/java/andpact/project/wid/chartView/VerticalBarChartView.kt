...
import andpact.project.wid.util.titleToKRMap
...
@Composable
fun VerticalBarChartView(
    titleToDurationMap: Map<String, Duration>,
    modifier: Modifier = Modifier
) {
    val TAG = "VerticalBarChartView"
...
@Composable
fun VerticalBarChartViewPreview() {
...
//        "9" to Duration.ZERO  // 수면 (Sleeping) - SLEEP
    ...
    VerticalBarChartView(titleToDurationMap = defaultTitleToDurationMap)
}