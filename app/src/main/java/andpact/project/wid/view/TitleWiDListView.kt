...
fun TitleWiDListView(
    ...
    // Current WiD
    val date = titleWiDListViewModel.date.value
    val start = titleWiDListViewModel.start.value
    val finish = titleWiDListViewModel.finish.value
    ...
    DisposableEffect(Unit) {
        ...
        titleWiDListViewModel.setToday(newDate = today)
